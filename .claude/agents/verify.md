...
- `test/verify/<slug>.verify.ts`
- `test/screenshots/<slug>-*.png` and any other screenshots regenerated by this verify run (Playwright rewrites PNGs even when the bytes barely change — those are part of the feature's evidence)
