---
name: plan
description: Use when starting a new UI pattern or feature. Reads TODO-POC.md, TECH-POC.md, and AGENTS.md, then produces acceptance criteria, a BDD test list, and fixture file specs. Writes no code. Must run before implement.
